...
public class Network implements NetworkInterface {
    ...
    @Override
    public int queryBestContributor(int id) throws UserIdNotFoundException,
            NoContributorsException {
        if (!containsUser(id)) {
    ...
    public void forwardVideo(int userId, int videoId, int followerId)
            throws UserIdNotFoundException, VideoIdNotFoundException, FollowLinkNotFoundException,
    ...
    public void sendComment(int userId, int videoId, int commentId, String comment)
            throws UserIdNotFoundException, VideoIdNotFoundException, EqualCommentIdException,
    ...
    public VideoInterface queryMostPopularVideo(String type) throws InvalidTypeException {
        ...
        for (VideoInterface v : videos) {
            ...
            double heat = v.getHeat();
            if (best == null || heat > bestHeat || (heat == bestHeat && v.getId() < best.getId())) {
                best = v;
                bestHeat = heat;
            }
        }
