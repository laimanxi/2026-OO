...
public class Video implements VideoInterface {
    ...
    @Override
    public int getHeat() {
        return playCount * 2 + likes * 3
                + forwardCount * 4 + coins * 5;
    }
    ...
    int[] cleanSpam(String keyword) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (hasKeywordMatch(content, keyword)) {
                maxKeywordCount = Math.max(maxKeywordCount,
    ...
    private static boolean hasKeywordMatch(String content,
                                            String keyword) {
        if (keyword.isEmpty()) {
            return true;
        }
    ...
    public boolean strictEquals(VideoInterface other) {
        ...
        Video o = (Video) other;
        if (id != o.id || uploaderId != o.uploaderId
                || playCount != o.playCount || likes != o.likes
                || forwardCount != o.forwardCount
                || coins != o.coins) {
            return false;
        }
        ...
        return commentIds.equals(o.commentIds)
                && commentContents.equals(o.commentContents);
    }
}
